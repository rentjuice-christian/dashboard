<?php render('_header',array('title'=>'Incoming Tickets by Office Type'))?>
<?php
...
<div class="align_center">
	<div class="manualmerges_title">Incoming Tickets by Office Type</div>
</div>
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="get" class="form_select" id="form_submit" >
	<div class="align_right">
		<input type="hidden" value="byofficetype" name="page" />
                   ...
                   (         
                    SELECT DISTINCT(r.name) region
                     ...
                     WHERE ca.customer_id = cu.id
                       AND cu.custom_office_id = o.id
                       AND o.region_id = r.id
                       AND DATE_ADD(created_at, INTERVAL 7 DAY) > SYSDATE()
                   ) regions,
