<?php render('_header',array('title'=>'Tag Usage Leaderboard'))?>
<?php

	$timeFrame = "";
	
	if(isset($_REQUEST['leaderboard_time'])){
...
?>
	...
	<div class="align_center">
		<div class="manualmerges_title">Tag Usage Leaderboard</div>
	</div>
...
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="get" class="form_select" id="form_submit" >
	<div class="align_right">
		<input type="hidden" value="tagusageleaderboard" name="page" />
				...
				?>
					<tr class="<?php echo $class; ?>">
						<td style="border-left:1px solid #cccccc;">
							<a href="index.php?page=tagusageovertime&tagusage_label=<?php echo urlencode($value->label_name); ?>&tagusage_time=<?php echo $timeFrame; ?>">
