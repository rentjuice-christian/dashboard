...
<?php
	...
	if(isset($_REQUEST['ticketsinboundbyoffice_time'])){ $timeFrame = $_REQUEST['ticketsinboundbyoffice_time']; }
	else{ $timeFrame = '4'; }
	...
	if($getValue != 0){
		...
		?>
			<td style="border-left:1px solid #cccccc;">
				<a href="http://clients.rentjuice.com/dashboard/index.php?page=ticketsearchforoffices&officename=<?php echo urlencode($value->officename); ?>&ticketsearch_time=8" class="tooltip" target="_blank">
					<img src="assets/images/user_ticket.png" alt="user tickets" />
					<div class="preview" style="display:none;">
					See all tickets of <?php echo $value->officename; ?>
					</div>
				</a>
				&nbsp;
				<a href="http://clients.rentjuice.com/dashboard/index.php?page=resolvedbysupertag&users=all&offices=<?php echo urlencode($value->office_id); ?>&movingaverage=7&timespan=<?php echo $timeFrame; ?>&type=1" class="tooltip" target="_blank">
...
SELECT o.id office_id, o.name, COUNT(*)as ticket_count, SUM(TIMESTAMPDIFF(MINUTE,first_opened_at,resolved_at)) handle_time_total
...
<?php 
	$start = array('start_time'=>$start_time,'start_width'=>'48%');
